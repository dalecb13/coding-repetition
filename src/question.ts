...
import { DataStoreAlgorithm } from "./data-store-algorithm/data-store-algorithm";
import { DataStore } from "./data-stores/base/data-store";
import { Note } from "./note";
import { ParsedQuestionInfo } from "./parser";
import { SRSettings } from "./settings";
import { TopicPath, TopicPathList, TopicPathWithWs } from "./topic-path";
import { cyrb53, MultiLineTextFinder, stringTrimStart, TextDirection } from "./utils/strings";
...
export class QuestionText {
    ...
    static splitText(original: string, settings: SRSettings): [TopicPathWithWs, string, string | null] {
    ...
    static extractObsidianBlockId(text: string): [string, string | null] {
